...
- If a browser/OS combo renders lowercase `s` incorrectly in descriptions (looks like words are missing `s`), force a monospace font stack for the description field to avoid glyph rendering quirks.
