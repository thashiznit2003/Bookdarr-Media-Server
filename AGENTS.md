...
- EPUB reader uses full-screen touch mode with overlay back/progress and iframe swipe handling; auth storage is guarded for iOS/Safari and unauthenticated users are redirected to login on any route.
