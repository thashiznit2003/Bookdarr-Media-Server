...
- Readium server/web integration removed due to dependency security issues; BMS web reading uses EPUB.js only (future mobile apps should use Readium native SDKs).
...
- EPUB.js now uses scrolled-doc layout to avoid split-page rendering in browsers.
...
- EPUB reader now shows debug metrics in the header for blank-page troubleshooting.
